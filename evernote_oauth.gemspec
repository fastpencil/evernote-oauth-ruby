...
Gem::Specification.new do |s|
  ...
  s.description = %q{evernote_oauth is a Ruby (1.8.7) client for the Evernote API using OAuth and Thrift.}
  ...
  s.summary = %q{evernote_oauth is a Ruby (1.8.7) client for the Evernote API using OAuth and Thrift.}
